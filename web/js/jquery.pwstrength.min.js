...
(function ($) {
    ...
    var options = {
            ...
            minChar: 8,
            errorMessages: {
                password_to_short: "Le mot de passe est trop court",
                same_as_username: "Votre mot de passe ne peut pas être identique à votre nom d\'utilisateur"
            },
            scores: [17, 26, 40, 50],
        ...
        setProgressBar = function ($el, score) {
            ...
            if (score < options.scores[0]) {
                progressbar.find(".progress-bar").addClass("progress-bar-danger").removeClass("progress-bar-warning").removeClass("progress-success");
                ...
                progressbar.find(".progress-bar").addClass("progress-bar-warning").removeClass("progress-bar-danger").removeClass("progress-success");
                ...
                progressbar.find(".progress-bar").addClass("progress-bar-success").removeClass("progress-bar-warning").removeClass("progress-danger");
        ...
        progressWidget = function () {
            return '<div class="progress" id="pwd-progress-bar"><div class="progress-bar"></div></div>';
        },
