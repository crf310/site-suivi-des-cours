...
/**
 * Virgule\Bundle\MainBundle\Entity\Attachment
 *
 * @ORM\Table(name="attachments")
 * @ORM\Entity(repositoryClass="Virgule\Bundle\MainBundle\Repository\AttachmentRepository")
 */
class Attachment {
    ...
    /**
     * @ORM\ManyToOne(targetEntity="ClassSession", inversedBy="attachments")
