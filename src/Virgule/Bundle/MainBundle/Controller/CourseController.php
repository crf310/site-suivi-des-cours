...
class CourseController extends AbstractVirguleController {
  ...
  public function printPlanningAction(Request $request) {
    ...
    return $pdfGenerator->downloadFromView(
                    'VirguleMainBundle:Course:planning.print.html.twig', $this->generatePlanning(true, $classRooms), array('orientation' => 'landscape')
    );
  }
  ...
  public function showPlanningAction() {
    ...
    return array_merge(
            array('selectClassRoomForm' => $selectClassRoomForm->createView()), $this->generatePlanning()
    );
  }
