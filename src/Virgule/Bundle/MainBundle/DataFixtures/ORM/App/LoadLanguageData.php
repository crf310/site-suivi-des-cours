...
class LoadLanguageData extends AbstractFixture implements OrderedFixtureInterface {
    ...
    public function load(ObjectManager $manager) {
        $languages = Array('Farsi', 'Wolof (Baol)', 'Soneke', 'Tibétain', 'Dari', 'Pachto (Pashto, Pachtoune)', 'Afghan', 'Moldave', 'Cambodgien', 'Sénégalais', 'Betsimisaraka', 'Peuhl', 'Senifou', 'Bambara', 'Sinhala(Sinhalese)', 'Gujarati', 'Urdu', 'Bambara', 'Patchou', 'Kabyle', 'Malien', 'Ivoirien', 'Dida', 'Dula', 'Ilokano', 'Pakistanais', 'Egyptien', 'Kurde', 'Yoruba', 'Comorien', 'Ousbek', 'Afrikaaner', 'Mandinge', 'Créole mauricien', 'Khassanke', 'Erythréen', 'Salinke', 'Punjabi', 'Igbo', 'Wenzhou (Oujiang)', 'Mandarin', 'Créole', 'Lingala', 'Pendjabi', 'Berbère', 'Créoles antillais', 'Créole guyanais', 'Créole louisianais', 'Créole mascarin (bourbonnais)', 'Kpellé', 'Kissi', 'Bassari', 'Malinké', 'Loma', 'Poular', 'Soussou', 'Konianké', 'Ewe', 'Guège', 'Hausa', 'Igbo', 'Yoruba', 'Ibibio', 'Edo', 'Fulfulde', 'Kanuri', 'Ijaw', 'Jaffna (dialecte Tamoul)', 'Batticaloa (dialecte Tamoul)', 'Negombo (dialecte Tamoul)', 'Tagalog (Tagal)');
