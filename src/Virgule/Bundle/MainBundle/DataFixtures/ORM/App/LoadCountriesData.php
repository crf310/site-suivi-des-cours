...
class LoadCountriesData extends AbstractFixture implements OrderedFixtureInterface {
	...
	$country30->setIsoCode(strtolower("BQ"));
	...
	$country31->setIsoCode(strtolower("BA"));
	...
	$country56->setIsoCode(strtolower("KP"));
	...
	$country105->setIsoCode(strtolower("VG"));
	...
	$country106->setIsoCode(strtolower("VI"));
	...
	$country150->setIsoCode(strtolower("MD"));
	...
	$country167->setIsoCode(strtolower("NZ"));
	...
	$country168->setIsoCode(strtolower("IO"));
	...
	$country193->setIsoCode(strtolower("BL"));
	...
	$country194->setIsoCode(strtolower("SH"));
	...
	$country199->setIsoCode(strtolower("SX"));
	...
	$country200->setIsoCode(strtolower("PM"));
	...
	$country201->setIsoCode(strtolower("VA"));
	...
	$country202->setIsoCode(strtolower("VC"));
	...
	$country206->setIsoCode(strtolower("ST"));
	...
	$country226->setIsoCode(strtolower("TZ"));
	...
	$country229->setIsoCode(strtolower("TF"));
