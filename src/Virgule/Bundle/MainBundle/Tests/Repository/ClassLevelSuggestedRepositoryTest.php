...
class ClassLevelSuggestedRepositoryTest extends AbstractRepositoryTest {
  ...
  public function getClassLevelsHistoryPerStudent_studentHasThreeRecords_correctClassLevelsReturned() {
    ...
    $this->assertEquals('User Lastname 1', $classLevel['teacher_firstName'] . ' ' . $classLevel['teacher_lastName'], 'Changer name is wrong [0]');
    ...
    $this->assertEquals('User Lastname 3', $classLevel['teacher_firstName'] . ' ' . $classLevel['teacher_lastName'], 'Changer name is wrong [1]');
    ...
    $this->assertEquals('User Lastname 1', $classLevel['teacher_firstName'] . ' ' . $classLevel['teacher_lastName'], 'Changer name is wrong [2]');
  ...
  public function getCurrentClassLevelSuggested_studentHasThreeRecords_latestOneIsReturned() {
    ...
    $this->assertEquals('User Lastname 1', $currentClassLevel->getChanger()->getFullName(), 'Changer name is wrong');
